  ...
  return (
    <div ref={rootRef} className="relative">
      <button
        ...
        className="relative flex h-8 w-8 items-center justify-center rounded-full text-muted-foreground transition-colors hover:bg-[#e52129]/10 hover:text-[#e52129]"
      ...
      {open && (
        <div className="absolute right-0 top-10 z-[80] w-[min(22rem,calc(100vw-2rem))] overflow-hidden rounded-xl border border-gray-200 bg-white shadow-xl">
          ...
          <div className="max-h-80 overflow-y-auto">
            {items.length === 0 ? (
              ...
              <Link
                ...
                onClick={() => { if (!item.readAt) markRead(item.id); setOpen(false); }}
